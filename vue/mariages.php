		...
		<main class="content">
			<div class="container-fluid p-0">
				<h1 class="h2 mb-3 text-center animate__animated animate__fadeIn">
					...
					<font class="align-middle">Liste des mariages</font>
				</h1>
				<div class="row">
					<div class="col-12">
						<div class="card animate__animated animate__fadeIn">
							<div class="card-header">
								<a class="btn btn-success active fw-bold" data-bs-toggle="modal" href="#add-mariage">
									...
									<tbody>
										...
										<tr>
											...
											<td class="table-action">
												<a class="btn btn-danger active fw-bold" href="mariages&idhab1=<?= $donnees['idhab1'] ?>" onclick="return(confirm('Voulez-vous vraiment supprimer ce mariage ?'));">
													Supprimer
												</a>
											</td>
										</tr>
						...
						<div class="d-flex justify-content-center">
							<form method="post" action="">
								<button type="submit" name="delete" class="btn btn-danger fs-lg active" onclick="return(confirm('Voulez-vous vraiment supprimer tous les mariages ?'));">
...
<div class="modal fade" id="add-mariage" tabindex="-1" aria-hidden="true">
  	<div class="modal-dialog">
    	<div class="modal-content">
	      	<div class="modal-header">
	        	<h3 class="modal-title">Ajouter un mariage</h3>
	        	<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
	      	</div>
	      	<div class="modal-body">
	        	<form method="post" action="">
					<div class="mb-3">
						<label for="prenomhab1" class="form-label text-dark">
							<i class="align-middle me-1 fas fa-fw fa-user-alt"></i>
							Le marie
						</label>
						<select name="prenomhab1" id="prenomhab1" class="form-select">
					...
					<div class="mb-3">
						<label for="prenomhab2" class="form-label text-dark">
							<i class="align-middle me-1 fas fa-fw fa-pen"></i>
							La mariée
						</label>
						<select name="prenomhab2" id="prenomhab2" class="form-select">
							<?php $requete = $bdd->query("SELECT * FROM habitants;");
							$lesHabitants = $requete->fetchAll();
							foreach ($lesHabitants as $unHabitant) { ?>
							<option value="<?= $unHabitant['idhab'] ?>"><?= $unHabitant['prenomhab'] ?></option>
