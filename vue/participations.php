									...
									<tbody>
										...
										<tr>
											...
											<td class="table-action">
												<a class="btn btn-primary active fw-bold me-3" href="participations&edit=<?= $donnees['idpart'] ?>">
													Modifier
												</a>
												<a class="btn btn-danger active fw-bold" href="participations&idpart=<?= $donnees['idpart'] ?>" onclick="return(confirm('Voulez-vous vraiment supprimer cette participation ?'));">
													Supprimer
												</a>
											</td>
										</tr>
