		...
		<main class="content">
			<div class="container-fluid p-0">
				<h1 class="h2 mb-3 text-center animate__animated animate__fadeIn">
					...
					<font class="align-middle">Liste des inscriptions d'écoles</font>
				</h1>
				<div class="row">
					<div class="col-12">
						<div class="card animate__animated animate__fadeIn">
							...
							<div class="card-body">
								<table id="datatables-reponsive" class="table text-center table-striped" style="width:100%">
									...
									<tbody>
										<?php
										$view = $bdd->query("SELECT * FROM inscrits_ecoles ORDER BY id_ins DESC");
										...
										<tr>
											...
											<td class="table-action">
												<a class="btn btn-danger active fw-bold" href="inscriptions_ecoles&id_ins=<?= $donnees['id_ins'] ?>" onclick="return(confirm('Voulez-vous vraiment supprimer cet élève ?'));">
													Supprimer
												</a>
											</td>
										</tr>
    	...
    	<div class="modal-content">
	      	...
	      	<div class="modal-body">
	        	<form method="post" action="">
					...
					<div class="mb-3">
						<label for="ecole" class="form-label text-dark">
							<i class="align-middle me-1 fas fa-fw fa-school"></i>
							Nom de l'école
						</label>
