                            ...
                            <table class="table">
								...
								<tbody>
									...
									<tr>
										...
										<td><?= $donnees['ecole'] ?></td>
										<td>
											<a class="btn btn-danger font-weight-bolder" href="inscriptions_ecoles&id_ins=<?= $donnees['id_ins'] ?>" onclick="return(confirm('Voulez-vous vraiment supprimer cet élève ?'));">
                                                <i data-feather="x"></i>
                                            </a>
										</td>
									</tr>
