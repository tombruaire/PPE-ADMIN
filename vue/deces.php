		...
		<main class="content">
			<div class="container-fluid p-0">
				<h1 class="h2 mb-3 text-center animate__animated animate__fadeIn">
					...
					<font class="align-middle">Liste des décès</font>
				</h1>
				<div class="row">
					<div class="col-12">
									...
									<tbody>
										...
										<tr>
											...
											<td class="table-action">
												<a class="btn btn-danger active fw-bold" href="deces&idd=<?= $donnees['idd'] ?>" onclick="return(confirm('Voulez-vous vraiment supprimer ce décès ?'));">
													Supprimer
												</a>
											</td>
										</tr>
						...
						<div class="d-flex justify-content-center">
							<form method="post" action="">
								<button type="submit" name="delete" class="btn btn-danger fs-lg active" onclick="return(confirm('Voulez-vous vraiment supprimer tout les décès ?'));">
  	...
  	<div class="modal-dialog">
    	<div class="modal-content">
	      	<div class="modal-header">
	        	<h3 class="modal-title">Ajouter un décès</h3>
	      	...
	      	<div class="modal-body">
	        	<form method="post" action="">
					...
					<div class="mb-3">
						...
						<select name="prenomhab" id="prenomhab" class="form-select form-control-lg">
